...
import com.spilowagie.text.pdf.PdfPTableEvent;
...
public class SimpleTable extends Rectangle implements PdfPTableEvent, TextElementArray {
	...
	/**
     * @see com.spilowagie.text.pdf.PdfPTableEvent#tableLayout(com.spilowagie.text.pdf.PdfPTable, float[][], float[], int, int, com.spilowagie.text.pdf.PdfContentByte[])
 	 */
	...
	/**
	 * @see com.spilowagie.text.TextElementArray#add(java.lang.Object)
	 */
