...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setGrayFill(float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetGrayFill()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setGrayStroke(float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetGrayStroke()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setRGBColorFillF(float, float, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetRGBColorFill()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setRGBColorStrokeF(float, float, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetRGBColorStroke()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setCMYKColorFillF(float, float, float, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetCMYKColorFill()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setCMYKColorStrokeF(float, float, float, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#resetCMYKColorStroke()
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#addImage(com.spilowagie.text.Image, float, float, float, float, float, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int, int)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setCMYKColorStroke(int, int, int, int)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setRGBColorFill(int, int, int)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setRGBColorStroke(int, int, int)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setColorStroke(java.awt.Color)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setColorFill(java.awt.Color)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setColorFill(com.spilowagie.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setColorStroke(com.spilowagie.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setPatternFill(com.spilowagie.text.pdf.PdfPatternPainter)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setPatternFill(com.spilowagie.text.pdf.PdfPatternPainter, java.awt.Color, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setPatternStroke(com.spilowagie.text.pdf.PdfPatternPainter, java.awt.Color, float)
     */
    ...
    /**
     * @see com.spilowagie.text.pdf.PdfContentByte#setPatternStroke(com.spilowagie.text.pdf.PdfPatternPainter)
     */
