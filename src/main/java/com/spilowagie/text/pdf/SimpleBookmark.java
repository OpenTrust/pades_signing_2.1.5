 ...
 * <p>
 * The list structure is composed by a number of LinkedHashMap, keyed by strings, one LinkedHashMap
 * for each bookmark.
...
public final class SimpleBookmark implements SimpleXMLDocHandler {
	...
	private static void mapGotoBookmark(LinkedHashMap map, PdfObject dest, IntHashtable pages) 
	{
		if (dest.isString())
			map.put("Named", dest.toString());
		else if (dest.isName())
    ...
    static void createOutlineAction(PdfDictionary outline, LinkedHashMap map, PdfWriter writer, boolean namedAsNames) {
        try {
    ...
    public void endElement(String tag) {
        ...
        LinkedHashMap attributes = (LinkedHashMap)attr.pop();
        ...
        if (attr.isEmpty())
            ...
            LinkedHashMap parent = (LinkedHashMap)attr.peek();
    ...
    public void startElement(String tag, LinkedHashMap h) {
        ...
        LinkedHashMap attributes = new LinkedHashMap(h);
    ...
    public void text(String str) {
        if (attr.isEmpty())
            return;
        LinkedHashMap attributes = (LinkedHashMap)attr.peek();
        String title = (String)attributes.get("Title");
        title += str;
