...
class TrueTypeFontSubSet {
     ...
     */
    protected LinkedHashMap tableDirectory;
    /** The file in use.
     */
    ...
    protected LinkedHashMap glyphsUsed;
     ...
     */
    TrueTypeFontSubSet(String fileName, RandomAccessFileOrArray rf, LinkedHashMap glyphsUsed, int directoryOffset, boolean includeCmap, boolean includeExtras) {
    ...
    protected void createTableDirectory() throws IOException, DocumentException {
        tableDirectory = new LinkedHashMap();
