...
import com.spilowagie.text.xml.simpleparser.IanaEncodings;
...
public final class SimpleNamedDestination implements SimpleXMLDocHandler {
    ...
    private LinkedHashMap xmlNames;
    private LinkedHashMap xmlLast;

    private SimpleNamedDestination() {
    }
    
    public static LinkedHashMap getNamedDestination(PdfReader reader, boolean fromNames) {
        IntHashtable pages = new IntHashtable();
        int numPages = reader.getNumberOfPages();
        for (int k = 1; k <= numPages; ++k)
            pages.put(reader.getPageOrigRef(k).getNumber(), k);
        LinkedHashMap names = fromNames ? reader.getNamedDestinationFromNames() : reader.getNamedDestinationFromStrings();
     ...
     */
    public static void exportToXML(LinkedHashMap names, OutputStream out, String encoding, boolean onlyASCII) throws IOException {
     ...
     * @throws IOException on error
     */
    public static void exportToXML(LinkedHashMap names, Writer wrt, String encoding, boolean onlyASCII) throws IOException {
     ...
     * @return the names
     */
    public static LinkedHashMap importFromXML(InputStream in) throws IOException {
     ...
     * @return the names
     */
    public static LinkedHashMap importFromXML(Reader in) throws IOException {
        SimpleNamedDestination names = new SimpleNamedDestination();
        SimpleXMLParser.parse(names, in);
        return names.xmlNames;
    }
    ...
    public static PdfDictionary outputNamedDestinationAsNames(LinkedHashMap names, PdfWriter writer) {
    ...
    public static PdfDictionary outputNamedDestinationAsStrings(LinkedHashMap names, PdfWriter writer) throws IOException {
        LinkedHashMap n2 = new LinkedHashMap(names);
