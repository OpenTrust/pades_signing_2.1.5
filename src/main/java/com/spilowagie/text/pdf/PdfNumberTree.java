...
public class PdfNumberTree {
     ...
     */    
    public static PdfDictionary writeTree(LinkedHashMap items, PdfWriter writer) throws IOException {
        if (items.isEmpty())
            return null;
    ...
    private static void iterateItems(PdfDictionary dic, LinkedHashMap items) {
    ...
    public static LinkedHashMap readTree(PdfDictionary dic) {
