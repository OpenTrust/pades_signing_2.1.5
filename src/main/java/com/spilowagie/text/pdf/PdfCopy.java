...
public class PdfCopy extends PdfWriter {
    ...
    protected LinkedHashMap indirects;
    protected LinkedHashMap indirectMap;
    ...
    protected LinkedHashMap fieldTemplates;
    ...
    protected void setFromReader(PdfReader reader) {
        this.reader = reader;
        indirects = (LinkedHashMap)indirectMap.get(reader);
        if (indirects == null) {
            indirects = new LinkedHashMap();
    ...
    public void addPage(Rectangle rect, int rotation) {
    	...
    	PdfPage page = new PdfPage(mediabox, new LinkedHashMap(), resources.getResources(), 0);
