...
/** cache for the fonts already used. */
    protected static LinkedHashMap fontCache = new LinkedHashMap();
    
/** list of the 14 built in fonts. */
    protected static final LinkedHashMap BuiltinFonts14 = new LinkedHashMap();
...
// ia>    
    ...
    // OT Patch : subsetPrefix needs to be random AND identical in preSign/postSign
	public static String createSubsetPrefix(long dateSeed) {
        String s = "";
        Random r = new Random(dateSeed);
        for (int k = 0; k < 6; ++k)
            s += (char)(r.nextDouble() * 26 + 'A');
        return s + "+";
    }
