...
public class PdfEncodings {
    ...
    static LinkedHashMap extraEncodings = new LinkedHashMap();
    ...
    static final LinkedHashMap cmaps = new LinkedHashMap();
    ...
    public static void addExtraEncoding(String name, ExtraEncoding enc) {
        synchronized (extraEncodings) { // This serializes concurrent updates
            LinkedHashMap newEncodings = (LinkedHashMap)extraEncodings.clone();
