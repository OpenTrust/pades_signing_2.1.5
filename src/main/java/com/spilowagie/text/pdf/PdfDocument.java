...
import com.spilowagie.text.Anchor;
import com.spilowagie.text.Annotation;
import com.spilowagie.text.BadElementException;
...
import com.spilowagie.text.HeaderFooter;
import com.spilowagie.text.Image;
import com.spilowagie.text.List;
import com.spilowagie.text.ListItem;
import com.spilowagie.text.MarkedObject;
import com.spilowagie.text.MarkedSection;
import com.spilowagie.text.Meta;
import com.spilowagie.text.Paragraph;
import com.spilowagie.text.Phrase;
import com.spilowagie.text.Rectangle;
import com.spilowagie.text.Section;
import com.spilowagie.text.SimpleTable;
import com.spilowagie.text.Table;
import com.spilowagie.text.pdf.collection.PdfCollection;
import com.spilowagie.text.pdf.draw.DrawInterface;
import com.spilowagie.text.pdf.internal.PdfAnnotationsImp;
 ...
 *
 * @see		com.spilowagie.text.Document
 * @see		com.spilowagie.text.DocListener
 * @see		PdfWriter
...
public class PdfDocument extends Document {
    ...
    static class PdfCatalog extends PdfDictionary {
         ...
         * @param writer the writer the catalog applies to
         */
        void addNames(TreeMap localDestinations, LinkedHashMap documentLevelJS, LinkedHashMap documentFileAttachment, PdfWriter writer) {
...
//	[L6] DocListener interface
    ...
    /**
     * @see com.spilowagie.text.DocListener#setMarginMirroring(boolean)
     */
...
//	[C5] named objects: local destinations, javascript, embedded files
     ...
     */
    int jsCounter;
    protected LinkedHashMap documentLevelJS = new LinkedHashMap();
    ...
    protected LinkedHashMap documentFileAttachment = new LinkedHashMap();
    ...
    LinkedHashMap getDocumentFileAttachment() {
...
//	[U1] page sizes
    ...
    protected LinkedHashMap thisBoxSize = new LinkedHashMap();

    /** This is the size of the several boxes that will be used in
     * the next page. */
    protected LinkedHashMap boxSize = new LinkedHashMap();
