...
package com.spilowagie.text.pdf.draw;
...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * @see com.spilowagie.text.pdf.draw.DrawInterface#draw(com.spilowagie.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
    ...
    /**
     * @see com.spilowagie.text.Element#process(com.spilowagie.text.ElementListener)
     */
    ...
    /**
     * @see com.spilowagie.text.Element#type()
     */
    public int type() {
    ...
    /**
     * @see com.spilowagie.text.Element#getChunks()
     */
