 ...
 * <P>
 * When using variable borders ({@link com.spilowagie.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		com.spilowagie.text.Rectangle
 * @see		com.spilowagie.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link com.spilowagie.text.Rectangle}
