...
public class FdfWriter {
    ...
    void iterateFields(LinkedHashMap values, LinkedHashMap map, String name) {
        for (Iterator it = map.entrySet().iterator(); it.hasNext();) {
            Map.Entry entry = (Map.Entry) it.next();
            String s = (String) entry.getKey();
            Object obj = entry.getValue();
            if (obj instanceof LinkedHashMap)
                iterateFields(values, (LinkedHashMap)obj, name + "." + s);
            else
    ...
    public void setFields(FdfReader fdf) {
        LinkedHashMap map = fdf.getFields();
        for (Iterator it = map.entrySet().iterator(); it.hasNext();) {
            Map.Entry entry = (Map.Entry) it.next();
    ...
    static class Wrt extends PdfWriter {
        ...
        PdfArray calculate(LinkedHashMap map) throws IOException {
            ...
            for (Iterator it = map.entrySet().iterator(); it.hasNext();) {
                ...
                if (v instanceof LinkedHashMap) {
                    dic.put(PdfName.KIDS, calculate((LinkedHashMap)v));
                }
