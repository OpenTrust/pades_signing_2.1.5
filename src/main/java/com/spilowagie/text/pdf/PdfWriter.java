...
package com.spilowagie.text.pdf;
...
import com.spilowagie.text.DocListener;
import com.spilowagie.text.DocWriter;
...
import com.spilowagie.text.ImgJBIG2;
import com.spilowagie.text.ImgWMF;
import com.spilowagie.text.Rectangle;
import com.spilowagie.text.Table;
import com.spilowagie.text.pdf.collection.PdfCollection;
import com.spilowagie.text.pdf.events.PdfPageEventForwarder;
import com.spilowagie.text.pdf.interfaces.PdfAnnotations;
import com.spilowagie.text.pdf.interfaces.PdfDocumentActions;
import com.spilowagie.text.pdf.interfaces.PdfEncryptionSettings;
import com.spilowagie.text.pdf.interfaces.PdfPageActions;
import com.spilowagie.text.pdf.interfaces.PdfRunDirection;
import com.spilowagie.text.pdf.interfaces.PdfVersion;
import com.spilowagie.text.pdf.interfaces.PdfViewerPreferences;
import com.spilowagie.text.pdf.interfaces.PdfXConformance;
import com.spilowagie.text.pdf.internal.PdfVersionImp;
import com.spilowagie.text.pdf.internal.PdfXConformanceImp;
import com.spilowagie.text.xml.xmp.XmpWriter;
 ...
 */
     ...
     * @param dest the <CODE>LinkedHashMap</CODE> containing the destinations
...
//	Open and Close methods + method that create the PDF
     ...
     * @see com.spilowagie.text.DocWriter#open()
     */
    public void open() {
        super.open();
        try {
     ...
     * @see com.spilowagie.text.DocWriter#close()
     */
    public void close() {
        if (open) {
...
//	[C2] PdfVersion interface
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfVersion#setPdfVersion(char) */
    public void setPdfVersion(char version) {
        pdf_version.setPdfVersion(version);
    }

    /** @see com.spilowagie.text.pdf.interfaces.PdfVersion#setAtLeastPdfVersion(char) */
    public void setAtLeastPdfVersion(char version) {
    	pdf_version.setAtLeastPdfVersion(version);
    }

	/** @see com.spilowagie.text.pdf.interfaces.PdfVersion#setPdfVersion(com.spilowagie.text.pdf.PdfName) */
	public void setPdfVersion(PdfName version) {
		pdf_version.setPdfVersion(version);
	}

	/**
	 * @see com.spilowagie.text.pdf.interfaces.PdfVersion#addDeveloperExtension(com.spilowagie.text.pdf.PdfDeveloperExtension)
	 * @since	2.1.6
	 */
...
//  [C3] PdfViewerPreferences interface
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfViewerPreferences#setViewerPreferences(int) */
    public void setViewerPreferences(int preferences) {
        pdf.setViewerPreferences(preferences);
    }

    /** @see com.spilowagie.text.pdf.interfaces.PdfViewerPreferences#addViewerPreference(com.spilowagie.text.pdf.PdfName, com.spilowagie.text.pdf.PdfObject) */
...
// [C6] Actions (open and additional)
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfDocumentActions#setOpenAction(java.lang.String) */
    public void setOpenAction(String name) {
         pdf.setOpenAction(name);
     }

    /** @see com.spilowagie.text.pdf.interfaces.PdfDocumentActions#setOpenAction(com.spilowagie.text.pdf.PdfAction) */
    public void setOpenAction(PdfAction action) {
         pdf.setOpenAction(action);
     }

    /** @see com.spilowagie.text.pdf.interfaces.PdfDocumentActions#setAdditionalAction(com.spilowagie.text.pdf.PdfName, com.spilowagie.text.pdf.PdfAction) */
...
//  [C8] AcroForm
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfAnnotations#getAcroForm() */
    public PdfAcroForm getAcroForm() {
        return pdf.getAcroForm();
    }

    /** @see com.spilowagie.text.pdf.interfaces.PdfAnnotations#addAnnotation(com.spilowagie.text.pdf.PdfAnnotation) */
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfAnnotations#addCalculationOrder(com.spilowagie.text.pdf.PdfFormField) */
    public void addCalculationOrder(PdfFormField annot) {
        pdf.addCalculationOrder(annot);
    }

    /** @see com.spilowagie.text.pdf.interfaces.PdfAnnotations#setSigFlags(int) */
...
//  [C10] PDFX Conformance
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfXConformance#setPDFXConformance(int) */
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfXConformance#getPDFXConformance() */
    public int getPDFXConformance() {
        return pdfxConformance.getPDFXConformance();
    }

    /** @see com.spilowagie.text.pdf.interfaces.PdfXConformance#isPdfX() */
...
//  [F1] PdfEncryptionSettings interface
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(byte[], byte[], int, int) */
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(java.security.cert.Certificate[], int[], int) */
...
//  [F4] adding (and releasing) form XObjects
    ...
    protected LinkedHashMap formXObjects = new LinkedHashMap();
...
//  [F5] adding pages imported form other PDF documents
    ...
    protected LinkedHashMap importedPages = new LinkedHashMap();
...
//  [F6] spot colors
    ...
    protected LinkedHashMap documentColors = new LinkedHashMap();
...
//  [F7] document patterns
    ...
    protected LinkedHashMap documentPatterns = new LinkedHashMap();
...
//  [F8] shading patterns
    ...
    protected LinkedHashMap documentShadingPatterns = new LinkedHashMap();
...
//  [F9] document shadings
    ...
    protected LinkedHashMap documentShadings = new LinkedHashMap();
...
// [F10] extended graphics state (for instance for transparency)
    ...
    protected LinkedHashMap documentExtGState = new LinkedHashMap();
...
//  [F11] adding properties (OCG, marked content)
    ...
    protected LinkedHashMap documentProperties = new LinkedHashMap();
...
//  [U3] page actions (open and close)
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfPageActions#setPageAction(com.spilowagie.text.pdf.PdfName, com.spilowagie.text.pdf.PdfAction) */
    ...
    /** @see com.spilowagie.text.pdf.interfaces.PdfPageActions#setDuration(int) */
    public void setDuration(int seconds) {
         pdf.setDuration(seconds);
     }

    /** @see com.spilowagie.text.pdf.interfaces.PdfPageActions#setTransition(com.spilowagie.text.pdf.PdfTransition) */
...
//  [M2] spot patterns
    ...
    protected LinkedHashMap documentSpotPatterns = new LinkedHashMap();
...
//  [M3] Images
    ...
    private LinkedHashMap images = new LinkedHashMap();
     ...
     * @since 2.1.5
     */
    protected LinkedHashMap JBIG2Globals = new LinkedHashMap();
    /**
...
//  [F12] tagged PDF
    ...
    // OT Patch addition
	protected Calendar signDate = new GregorianCalendar();
