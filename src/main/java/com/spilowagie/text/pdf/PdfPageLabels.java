...
import com.spilowagie.text.factories.RomanAlphabetFactory;
import com.spilowagie.text.factories.RomanNumberFactory;
...
public class PdfPageLabels {
    ...
    public static String[] getPageLabels(PdfReader reader) {
		...
		LinkedHashMap numberTree = PdfNumberTree.readTree(labels);
