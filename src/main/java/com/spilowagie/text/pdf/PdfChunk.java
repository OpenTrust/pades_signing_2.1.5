...
import com.spilowagie.text.SplitCharacter;
 ...
 *
 * @see		PdfString
 * @see		com.spilowagie.text.Chunk
 * @see		com.spilowagie.text.Font
 */
...
/** The allowed attributes in variable <CODE>attributes</CODE>. */
    private static final LinkedHashMap keysAttributes = new LinkedHashMap();
    
/** The allowed attributes in variable <CODE>noStroke</CODE>. */
    private static final LinkedHashMap keysNoStroke = new LinkedHashMap();
 ...
 * such as Color.
 */
    protected LinkedHashMap noStroke = new LinkedHashMap();
 ...
 */
    ...
    PdfChunk(Chunk chunk, PdfAction action) {
        ...
        LinkedHashMap attr = chunk.getAttributes();
        if (attr != null) {
