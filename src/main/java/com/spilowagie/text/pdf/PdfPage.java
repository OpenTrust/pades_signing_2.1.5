 ...
 */
    ...
    PdfPage(PdfRectangle mediaBox, LinkedHashMap boxSize, PdfDictionary resources, int rotate) {
        super(PAGE);
        this.mediaBox = mediaBox;
        put(PdfName.MEDIABOX, mediaBox);
        put(PdfName.RESOURCES, resources);
 ...
 */
    ...
    PdfPage(PdfRectangle mediaBox, LinkedHashMap boxSize, PdfDictionary resources) {
