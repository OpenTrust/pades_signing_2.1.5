...
import com.spilowagie.text.exceptions.IllegalPdfSyntaxException;
...
public class PdfContentByte {
    ...
    private static LinkedHashMap abrev = new LinkedHashMap();
     ...
     * Only use if {@link com.spilowagie.text.Rectangle#isUseVariableBorders() Rectangle.isUseVariableBorders}
     * = true.
