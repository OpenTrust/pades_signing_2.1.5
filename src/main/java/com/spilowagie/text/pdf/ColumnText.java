    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                com.spilowagie.text.List list = (com.spilowagie.text.List)element;
                ...
                for (int k = 0; k < items.size(); ++k) {
                    ...
                    else if (obj instanceof com.spilowagie.text.List) {
                        stack.push(new Object[]{list, new Integer(k), new Float(listIndentation)});
                        list = (com.spilowagie.text.List)obj;
                        items = list.getItems();
                    ...
                    if (k == items.size() - 1) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (com.spilowagie.text.List)objs[0];
                            items = list.getItems();
