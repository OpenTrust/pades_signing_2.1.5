...
public class Type3Font extends BaseFont {
    ...
    private LinkedHashMap char2glyph = new LinkedHashMap();
    ...
    void writeFont(PdfWriter writer, PdfIndirectReference ref, Object[] params) throws com.spilowagie.text.DocumentException, java.io.IOException {
