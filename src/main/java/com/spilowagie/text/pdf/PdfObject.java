...
public abstract class PdfObject {
	...
	protected int reverseRevision;
    public int getReverseRevision() {
		return reverseRevision;
	}
	public void setReverseRevision(int reverseRevision) {
		this.reverseRevision = reverseRevision;
	}
