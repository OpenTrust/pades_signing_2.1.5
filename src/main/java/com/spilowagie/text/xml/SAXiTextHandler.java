...
package com.spilowagie.text.xml;
...
import com.spilowagie.text.Cell;
import com.spilowagie.text.Chapter;
...
import com.spilowagie.text.factories.ElementFactory;
import com.spilowagie.text.html.HtmlTagMap;
import com.spilowagie.text.pdf.BaseFont;
import com.spilowagie.text.pdf.draw.LineSeparator;
import com.spilowagie.text.xml.simpleparser.EntitiesToSymbol;
...
public class SAXiTextHandler extends DefaultHandler {
    ...
    protected LinkedHashMap myTags;
     ...
     * @param myTags
     */
    public SAXiTextHandler(DocListener document, LinkedHashMap myTags) {
        this(document);
        this.myTags = myTags;
    }
