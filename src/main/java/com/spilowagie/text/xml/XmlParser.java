 ...
 */
    ...
    public void go(DocListener document, InputSource is, LinkedHashMap tagmap) {
        try {
 ...
 */
    ...
    public void go(DocListener document, String file, LinkedHashMap tagmap) {
        try {
 ...
 */
    ...
    public static void parse(DocListener document, InputSource is, LinkedHashMap tagmap) {
        XmlParser p = new XmlParser();
        p.go(document, is, tagmap);
    }
 ...
 */
    ...
    public static void parse(DocListener document, String file, LinkedHashMap tagmap) {
        XmlParser p = new XmlParser();
        p.go(document, file, tagmap);
    }
 ...
 */
    ...
    public static void parse(DocListener document, InputStream is, LinkedHashMap tagmap) {
        XmlParser p = new XmlParser();
        p.go(document, new InputSource(is), tagmap);
    }
 ...
 */
    ...
    public static void parse(DocListener document, Reader is, LinkedHashMap tagmap) {
        XmlParser p = new XmlParser();
        p.go(document, new InputSource(is), tagmap);
    }
}