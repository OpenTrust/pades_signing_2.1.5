...
/**
 * This class is a LinkedHashMap that contains the names of colors as a key and the
 * corresponding Color as value. (Source: Wikipedia
 * http://en.wikipedia.org/wiki/Web_colors )
 * 
 * @author blowagie
 */
public class WebColors extends LinkedHashMap {
    
	private static final long serialVersionUID = 3542523100813372896L;
	/** LinkedHashMap containing all the names and corresponding color values. */
