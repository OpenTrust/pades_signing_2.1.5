...
import com.spilowagie.text.xml.SAXiTextHandler;
import com.spilowagie.text.xml.XmlPeer;
...
public class SAXmyHtmlHandler extends SAXiTextHandler // SAXmyHandler
{
    ...
    public SAXmyHtmlHandler(DocListener document, LinkedHashMap htmlTags) {
