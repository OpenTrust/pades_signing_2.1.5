...
import com.spilowagie.text.pdf.HyphenationAuto;
import com.spilowagie.text.pdf.HyphenationEvent;
...
public class FactoryProperties {
	...
	/**
	 * Gets a HyphenationEvent based on the hyphenation entry in a LinkedHashMap.
	 * @param	props	a LinkedHashMap with properties
	 * @return	a HyphenationEvent
	 * @since	2.1.2
	 */
	public static HyphenationEvent getHyphenation(LinkedHashMap props) {
	 ...
	 * the value of a style attribute inside a LinkedHashMap.
	 * The different elements of the style attribute are added to the
	 * LinkedHashMap as key-value pairs.
	 * @param	h	a LinkedHashMap that should have at least a key named
	 * style. After this method is invoked, more keys could be added.
	 */
	public static void insertStyle(LinkedHashMap h) {
	 ...
	 * @since 2.1.3
	 */
	public static void insertStyle(LinkedHashMap h, ChainedProperties cprops) {
		String style = (String) h.get("style");
		if (style == null)
			return;
		Properties prop = Markup.parseAttributes(style);
	...
	public static LinkedHashMap followTags = new LinkedHashMap();
	static {
		followTags.put("i", "i");
		followTags.put("b", "b");
		followTags.put("u", "u");
